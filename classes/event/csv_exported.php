...
/**
 * Event triggered when a user exports the grade history CSV of a student.
 *
 * @package    report_lifestory
 * @copyright  2026 Datacurso
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class csv_exported extends \core\event\base {
    /**
     * Creates the event for a consulted student.
     *
     * @param int $studentid The id of the student whose grade history was exported.
    ...
    public static function get_name(): string {
        return get_string('event:csvexported', 'report_lifestory');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' exported the grade history CSV of the student " .
