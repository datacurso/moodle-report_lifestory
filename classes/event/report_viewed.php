...
/**
 * Event triggered when a user views the life story report of a student.
 *
...
final class report_viewed extends \core\event\base {
     ...
     *
     * @param int $studentid The id of the student whose report was viewed.
     * @param \context $context The context the report was viewed in.
    ...
    public static function get_name(): string {
        return get_string('event:reportviewed', 'report_lifestory');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' viewed the life story report of the student " .
