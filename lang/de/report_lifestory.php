...
$string['privacy:metadata:ai_provider'] = 'Daten werden an das KI-System des Unternehmens gesendet, um Feedback basierend auf der akademischen Laufbahn des Studenten zu generieren.';
$string['privacy:metadata:ai_provider:courses'] = 'Strukturierte Kurs- und Bewertungsinformationen für die KI-Analyse.';
$string['privacy:metadata:ai_provider:siteid'] = 'Gehashte Site-ID zur Unterscheidung der Moodle-Installation.';
$string['privacy:metadata:ai_provider:studentid'] = 'Benutzer-ID des analysierten Studierenden.';
$string['privacy:metadata:ai_provider:studentname'] = 'Vollständiger Name des analysierten Studierenden.';
$string['privacy:metadata:ai_provider:userid'] = 'ID des Benutzers, dessen akademische Laufbahn analysiert wird.';
