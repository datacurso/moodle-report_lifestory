...
$string['event:csvexported'] = 'Lebensgeschichte-CSV exportiert';
$string['event:feedbackgenerated'] = 'KI-Feedback zur Lebensgeschichte generiert';
$string['event:pdfexported'] = 'Lebensgeschichte-PDF exportiert';
$string['event:reportviewed'] = 'Lebensgeschichte-Bericht angesehen';
...
$string['searchnoresults'] = 'Keine Studierenden entsprechen Ihrer Suche.';
