...
$string['privacy:metadata:ai_provider:courses'] = 'Structured course and grade information used for AI analysis.';
$string['privacy:metadata:ai_provider:siteid'] = 'A hashed site identifier to distinguish the Moodle site.';
$string['privacy:metadata:ai_provider:studentid'] = 'The student user ID being analyzed.';
$string['privacy:metadata:ai_provider:studentname'] = 'The student full name being analyzed.';
