...
$string['event:csvexported'] = 'Life story CSV exported';
$string['event:feedbackgenerated'] = 'Life story AI feedback generated';
$string['event:pdfexported'] = 'Life story PDF exported';
$string['event:reportviewed'] = 'Life story report viewed';
...
$string['searchnoresults'] = 'No students match your search.';
