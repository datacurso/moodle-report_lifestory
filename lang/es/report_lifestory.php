...
$string['privacy:metadata:ai_provider:courses'] = 'Información estructurada de cursos y calificaciones usada para el análisis con IA.';
$string['privacy:metadata:ai_provider:siteid'] = 'Un identificador hash del sitio para distinguir la instalación Moodle.';
$string['privacy:metadata:ai_provider:studentid'] = 'El ID del estudiante que se analiza.';
$string['privacy:metadata:ai_provider:studentname'] = 'El nombre completo del estudiante que se analiza.';
