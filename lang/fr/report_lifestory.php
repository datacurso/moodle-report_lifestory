...
$string['privacy:metadata:ai_provider:courses'] = 'Informations structurées des cours et des notes utilisées pour l’analyse IA.';
$string['privacy:metadata:ai_provider:siteid'] = 'Identifiant du site haché pour distinguer l’installation Moodle.';
$string['privacy:metadata:ai_provider:studentid'] = 'ID de l’étudiant analysé.';
$string['privacy:metadata:ai_provider:studentname'] = 'Nom complet de l’étudiant analysé.';
$string['privacy:metadata:ai_provider:userid'] = 'ID de l’utilisateur dont l’historique académique est analysé.';
$string['range'] = 'Plage';
