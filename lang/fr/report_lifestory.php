...
$string['contributiontototal'] = 'Contribution au total du cours';
$string['course'] = 'Cours';
...
$string['event:csvexported'] = 'CSV de l’histoire de vie exporté';
$string['event:feedbackgenerated'] = 'Feedback IA de l’histoire de vie généré';
$string['event:pdfexported'] = 'PDF de l’histoire de vie exporté';
$string['event:reportviewed'] = 'Rapport d’histoire de vie consulté';
...
$string['feedbackgeneratedon'] = 'Retour généré le {$a}';
...
$string['nocoursesavailable'] = 'Cet étudiant n’a aucune inscription à un cours disponible à afficher dans ce rapport.';
...
$string['pdfnocoursedata'] = 'Aucune donnée de note n’est disponible pour ce cours.';
...
$string['range'] = 'Plage';
$string['regeneratefeedback'] = 'Régénérer le retour avec l’IA';
$string['searchbutton'] = 'Rechercher';
$string['searchmorematches'] = 'D’autres étudiants correspondent à votre recherche. Affinez le texte pour réduire les résultats.';
$string['searchnoresults'] = 'Aucun étudiant ne correspond à votre recherche.';
