...
$string['privacy:metadata:ai_provider:courses'] = 'Informasi kursus dan nilai terstruktur yang digunakan untuk analisis AI.';
$string['privacy:metadata:ai_provider:siteid'] = 'Pengenal situs berbentuk hash untuk membedakan instalasi Moodle.';
$string['privacy:metadata:ai_provider:studentid'] = 'ID pengguna siswa yang dianalisis.';
$string['privacy:metadata:ai_provider:studentname'] = 'Nama lengkap siswa yang dianalisis.';
