...
$string['privacy:metadata:ai_provider'] = 'Os dados são enviados ao sistema de IA da empresa para gerar feedback baseado no histórico acadêmico do estudante.';
$string['privacy:metadata:ai_provider:courses'] = 'Informações estruturadas de cursos e notas usadas na análise por IA.';
$string['privacy:metadata:ai_provider:siteid'] = 'Um identificador hash do site para distinguir a instalação Moodle.';
$string['privacy:metadata:ai_provider:studentid'] = 'O ID do estudante analisado.';
$string['privacy:metadata:ai_provider:studentname'] = 'O nome completo do estudante analisado.';
$string['privacy:metadata:ai_provider:userid'] = 'ID do usuário cujo histórico acadêmico é analisado.';
