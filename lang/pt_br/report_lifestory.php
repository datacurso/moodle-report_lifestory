...
$string['contributiontototal'] = 'Contribuição para o total do curso';
$string['course'] = 'Curso';
...
$string['event:csvexported'] = 'CSV da história de vida exportado';
$string['event:feedbackgenerated'] = 'Feedback de IA da história de vida gerado';
$string['event:pdfexported'] = 'PDF da história de vida exportado';
$string['event:reportviewed'] = 'Relatório de história de vida visualizado';
$string['exportcsv'] = 'Exportar para CSV';
$string['exportpdf'] = 'Exportar para PDF';
$string['feedback'] = 'Feedback';
$string['feedbackfromai'] = 'Feedback da IA';
$string['feedbackgeneratedon'] = 'Feedback gerado em {$a}';
...
$string['nocoursesavailable'] = 'Este estudante não possui inscrições em cursos disponíveis para exibir neste relatório.';
...
$string['pdfnocoursedata'] = 'Nenhum dado de notas está disponível para este curso.';
...
$string['regeneratefeedback'] = 'Regerar feedback com IA';
$string['searchbutton'] = 'Pesquisar';
$string['searchmorematches'] = 'Mais estudantes correspondem à sua pesquisa. Refine o texto para restringir os resultados.';
$string['searchnoresults'] = 'Nenhum estudante corresponde à sua pesquisa.';
