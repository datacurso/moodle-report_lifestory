...
$string['privacy:metadata:ai_provider'] = 'Данные отправляются в систему ИИ компании для генерации отзывов на основе академической истории студента.';
$string['privacy:metadata:ai_provider:courses'] = 'Структурированная информация о курсах и оценках для анализа ИИ.';
$string['privacy:metadata:ai_provider:siteid'] = 'Хешированный идентификатор сайта для различения установки Moodle.';
$string['privacy:metadata:ai_provider:studentid'] = 'ID студента, данные которого анализируются.';
$string['privacy:metadata:ai_provider:studentname'] = 'Полное имя студента, данные которого анализируются.';
